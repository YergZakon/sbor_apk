...
REFERENCES = {
    ...
    "pesticides": {
        "name": "🛡️ СЗР (пестициды, десиканты, действующие вещества)",
        "file": "pesticides.json",
        "description": "Единый справочник СЗР с классификацией: гербициды, инсектициды, фунгициды, протравители, регуляторы роста, десиканты, вспомогательные вещества",
        "icon": "🛡️"
    },
    "fertilizers": {
        "name": "💊 Удобрения",

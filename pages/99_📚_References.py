...
REFERENCES = {
    ...
    "soil_types": {
        "name": "🏔️ Типы почв",
        "file": "soil_types.json",
        "description": "Классификация типов почв, характеристики",
        "icon": "🏔️"
    },
    "countries": {
        "name": "🌍 Страны",
        "file": "countries.json",
        "description": "Страны происхождения семян и техники",
        "icon": "🌍"
    },
    "seed_reproductions": {
        "name": "🌱 Репродукции семян",
        "file": "seed_reproductions.json",
        "description": "Классификация репродукций семян (элита, РС-1, РС-2...)",
        "icon": "🌱"
    },
    "active_ingredients": {
        "name": "🧪 Действующие вещества",
        "file": "active_ingredients.json",
        "description": "Активные компоненты пестицидов и агрохимикатов",
        "icon": "🧪"
    },
    "pesticide_classes": {
        "name": "📋 Классы препаратов",
        "file": "pesticide_classes.json",
        "description": "Классификация средств защиты растений",
        "icon": "📋"
    },
    "fertilizer_categories": {
        "name": "🧬 Категории удобрений",
        "file": "fertilizer_categories.json",
        "description": "Типы и категории минеральных и органических удобрений",
        "icon": "🧬"
    },
    "desiccation_products": {
        "name": "💧 Десиканты",
        "file": "desiccation_products.json",
        "description": "Препараты для предуборочной десикации",
        "icon": "💧"
    }
}

...
try:
    ...
    if current_user:
        ...
        with tabs[1]:
            ...
            st.warning("⚠️ **Важно:** После регистрации администратор должен активировать ваш аккаунт и привязать к хозяйству.")
                ...
                if reg_submitted:
                    ...
                    if errors:
                        ...
                        try:
                            ...
                            st.info("💡 Теперь вы можете войти, используя свои учетные данные")
                            st.balloons()
